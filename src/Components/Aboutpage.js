        ...
        return (
            <div className="aboutwrapper">
                ...
                <div className="aboutinfo">
                    ...
                    <p className="bulkinfo"> I don't believe in high pressure - you should have the time that you need to find the perfect home.  Call or email me today and let's GET STARTED!</p>
                </div>
            </div>
        )
    }
